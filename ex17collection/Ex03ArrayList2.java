...
public class Ex03ArrayList2 {
	...
	public static void main(String[] args) {
		...
		/*
		 아래 2개의 컬렉션은 내부적 자료구조만 다를 뿐, 구현방법은 완전 동일
		...
		/*
		 객체삭제:
		  인덱스가 아닌 인스턴스의 참조값을 통해 삭제하는 경우
		  중복된 객체가 있으면 앞에 있는 객체 하나만 삭제됌
		 */
		list2.remove(st2);
		...
		System.out.println("삭제된 객체 이름:" + list2.remove(2).getName());
		System.out.println("객체 통한 삭제: " + list2.remove(st1));
		//list2.remove(st1); 
