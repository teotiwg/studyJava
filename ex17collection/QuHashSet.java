...
class Avengers {
	...
	@Override
	public int hashCode() {
		System.out.println("hashCode메소드 호출됌");
...
public class QuHashSet {
	...
	public static void main(String[] args) {
		...
		System.out.print("검색할 영웅의 이름을 입력하세요: ");
		Scanner scan = new Scanner(System.in);
		String find = scan.nextLine();
		
		for(Avengers hero : set) {
			if(hero.getName().equals(find)) {
				System.out.println(hero.toString());
				System.out.println("요청하신 정보를 찾았습니다.");
			}
			else
				System.out.println("요청하신 정보를 찾지 못했습니다.");
		}
