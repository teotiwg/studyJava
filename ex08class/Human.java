...
-행동의조건
	...
	(사람은 무한히 먹을수 없으며, 에너지가 마이너스가되면 죽은것과 같기때문)
 */
...
public class Human {
	...
	void walk() {
		...
		if(energy < 0) {
			...
			System.out.println("[walk]에너지가 1 감소했습니다.");
		}
	}
	...
	void thinking() {
		...
		if(energy < 0) {
			...
			System.out.println("[thinking]에너지가 2 감소했습니다.");
		}
	}
	...
	void eat() {
		...
		if(energy > 10) {
			...
			System.out.println("[eat]에너지가 2 증가했습니다.");
		}
	}
	
	// 객체의 현재 상태를 표현하는 멤버메소드
	void showState() {
