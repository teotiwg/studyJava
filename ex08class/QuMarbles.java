...
class ChildProperty{
	...
	String child;
	int marblesHave, marblesGet, marblesLost;
	
	public void ChildProperty(int a) {
		marblesHave = a;
	}
	
	void showProperty() {
		int property = child.marblesHave;
		System.out.print("보유 구슬의 갯수: " + property);
	}
	
	void obtainBead(String child, int b) {
		marblesHave += b;
	}
